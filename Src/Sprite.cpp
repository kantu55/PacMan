...
*/
void Sprite::SetTexture(const Texture::Image2DPtr& tex)
{
	texture = tex;
	SetRectangle( Rect{ glm::vec2(0), glm::vec2(tex->Width(), tex->Height() )});
}
